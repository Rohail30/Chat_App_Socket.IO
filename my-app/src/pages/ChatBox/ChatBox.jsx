...
//   // text: When user types text in an input field
//   const [text, setText] = useState("");
//   // receiver: User whom we are sending text
//   const [receiver, setReceiver] = useState(null);
//   //message: Message that we are sending to other side
//   const [message, setMessage] = useState([]);
//   // menuOpen: Menu that opens after 3 dots
//   const [menuOpen, setMenuOpen] = useState(false);
//   // selectionMode: When delete button is clicked then selecting messages to delete appears
//   const [selectionMode, setSelectionMode] = useState(false);
//   // selectedMessages: Messages that we select to delete
//   const [selectedMessages, setSelectedMessages] = useState([]);
//   // deleteOptions: Delete For Me or Delete For Everyone
//   const [deleteOptions, setDeleteOptions] = useState(false);

//   //@Type Socket && API  (message_read and fetchMessages)
//   //@desc Fetching previous Chat from Database
//   useEffect(() => {
...
//   //@Type Socket (message_read)
//   //@desc Update Blue Tick
//   useEffect(() => {
...
//     setSelectedMessages([]); // reset previous selections
//   };

//   const handleDeleteForMe = async () => {
//     const res = await apiRequest.patch("api/chat/deleteForMe", {
...
//       });
//     }
//     console.log("[Messages Deleted]", res.data);
//     setSelectionMode(false);
//     setMenuOpen((prev) => !prev);
//     setDeleteOptions(false);
//     console.log("[Selected Deleted Messages]==>", selectedMessages);
//     setSelectedMessages([]);
//   };

//   const handleDeleteForAll = async () => {
//     const res = await apiRequest.patch("api/chat/deleteForAll", {
//       messageIds: selectedMessages,
//     });
//     setSelectionMode(false);
//     setMenuOpen((prev) => !prev);
...
//   useEffect(() => {
//     console.log("[Updated Selected Messages]==>", selectedMessages);
//   }, [selectedMessages]);

//   const handleMenu = () => {
//     setMenuOpen((prev) => !prev); // toggles between true/false
//   };
...
//                 }`}
//                 onClick={() => selectionMode && toggleSelectMessage(msg._id)} // only selectable in selectionMode
//                 style={{
...
//                     <p>
//                       {msg.deletedForEveryone
//                         ? "" // show nothing if deleted for everyone
//                         : msg.deletedForMe
//                         ? "This message was deleted" // show text if deleted for me
//                         : msg.message}{" "}
